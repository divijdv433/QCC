...
create_clock -name MAIN_CLOCK -period 40 [get_ports clk_100_clk]
create_clock -name EMIF_REF_CLOCK -period 10 [get_ports ddr3_pll_inclk0]
create_clock -name {REFCLK_GXB_CHBP3} -period 8.0 [get_ports {REFCLK_GXB_CHBP3}]
